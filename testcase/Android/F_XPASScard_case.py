...
class XPASSTestCase(unittest.TestCase):
    ...
    @BeautifulReport.add_img('添加XPASS卡')
    ...
    @BeautifulReport.add_img('NPXS充值码')
    ...
    @BeautifulReport.add_img('NPXS转账')
    ...
    @BeautifulReport.add_img('ETH充值码')
    ...
    @BeautifulReport.add_img('BTC充值码')
    ...
    @BeautifulReport.add_img('BNB充值码')
