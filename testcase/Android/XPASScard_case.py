...
class XPASSTestCase(unittest.TestCase):
    ...
    # def test_003_check_XPASS_BTC_rec(self, coin='BTC'):
    #     """
    #     检查XPASS卡BTC的充值地址
    #     coin：币种，根据币种改变测试用例
    #     """
    ...
    #         print(f'无法获取{coin}充值二维码，请检查截图...')

    def test_004_check_XPASS_BTC_transfer(self, coin='BTC', address='213123123113', money='0.00000001'):
        """
        检查XPASS卡的BTC的转账
        coin：币种，根据币种改变测试用例
        """
    ...
    #     """
    #
    #     self.test_004_check_XPASS_BTC_transfer(coin='ETH')
    #
    # def test_007_XPASS_NPXS_rec(self):
    #     """
    #     检查XPASS卡NPXS的充值地址
    #     coin：币种，根据币种改变测试用例
    #     """
    #
    #     self.test_003_check_XPASS_BTC_rec(coin='NPXS')
    #
    # def test_008_check_XPASS_NPXS_transfer(self):
    #     """
    #     检查XPASS卡的NPXS的转账
    #     coin：币种，根据币种改变测试用例
    #     """
    #
    #     self.test_004_check_XPASS_BTC_transfer(coin='NPXS')
    #
    ...
    #     self.xpass_page.into_XPASS_card()
    #     self.xpass_page.into_coin_detail(coin='BNB')
    #     self.xpass_page.Click_Transfer_with_memo(address='23423534543dfhhfghghjgf')
    #     time.sleep(1)
    #     self.xpass_page.send_codes()  # 输入转账时的验证码
    #     time.sleep(1)
    #     self.xpass_page.confirm_transfer()
