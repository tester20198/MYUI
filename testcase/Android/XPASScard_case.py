...
class XPASSTestCase(unittest.TestCase):
    ...
    #
    # def test_004_check_XPASS_BTC_transfer(self, coin='BTC', address='',
    #                                       money='0.00001'):
    #     """
    #     检查XPASS卡的BTC的转账
    #     coin：币种，根据币种改变测试用例
    ...
    #     """
    #
    #     self.test_004_check_XPASS_BTC_transfer(coin='ETH', address='0xaA3A007c27F41B7527d339270b3c46EDAF51fe84', money='0.00001')
    ...
    #     """
    #
    #     self.test_004_check_XPASS_BTC_transfer(coin='NPXS', address='0xaA3A007c27F41B7527d339270b3c46EDAF51fe84', money='0.00001')
    #
