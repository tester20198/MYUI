...
from Page.Android.RegisterPage import registerPage
...
if __name__ == '__main__':
    # pytest.main(['-s', '--alluredir', '../../reports/data'])
    pytest.main(['-s', '/Users/pundix047/PycharmProjects/MYUI/testcase/Android/a_Register_test.py::TestRigister::test_002_email_register'])